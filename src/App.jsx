          ...
          : itemsCotizados.map((it) => (
            <div key={it.id} style={{ marginBottom: 12 }}>
              ...
              {quotesForItem(it.id).map((q, idx) => (
                <div key={q.id} className="mobile-quote-row" style={{ padding: '8px 12px', border: '0.5px solid var(--border)', borderRadius: 'var(--radius-md)', marginBottom: 4, marginLeft: 20, background: 'var(--bg-secondary)', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                  ...
                  <div className="mobile-quote-price" style={{ display: 'flex', alignItems: 'center', gap: 8, marginLeft: 8, flexShrink: 0 }}>
